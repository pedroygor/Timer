    ...
    <div className="w-full md:w-2/5 h-96 mx-auto bg-blue-700 rounded-md border-b-8 border-b-red-300">
      <div className="flex flex-col gap-5 items-center">
        ...
        <div className="flex gap-2">
          <button
            className="bg-green-300 w-full md:w-28 h-10 rounded-md uppercase text-lg transition-all duration-300 ease-in-out hover:bg-green-100 text-white-100"
            onClick={handleStart}>
            Start
          </button>
          <button
            className="w-full md:w-28 h-10 rounded-md border-2 border-white-400 uppercase text-lg transition-all duration-300 ease-in-out hover:bg-blue-500 text-white-100"
            onClick={handleStop}>
            Pause
          </button>
          <button
            className="bg-red-300 w-full md:w-28 h-10 rounded-md uppercase text-lg transition-all duration-300 ease-in-out hover:opacity-75 text-white-100"
            onClick={handleReset}>
            Reset
          </button>
        </div>
