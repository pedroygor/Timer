...
export const Countdown = () => {
  ...
  return (
    // <div className="w-2/5 h-96 ml-auto mr-auto bg-blue-700 rounded-md border-b-8 border-b-red-300">
    ...
    //       <div className='w-28 flex flex-col gap-3 justify-center items-center'>
    ...
    //       <button className='bg-green-300 w-28 h-10 rounded-md uppercase text-lg transition-all duration-300 ease-in-out hover:bg-green-100 text-white-100' onClick={handleStart}>Start</button>
    //       <button className='w-28 h-10 rounded-md border-2 border-white-400 uppercase text-lg transition-all duration-300 ease-in-out hover:bg-blue-500 text-white-100' onClick={handleStop}>Pause</button>
    //       <button className='bg-red-300 w-28 h-10 rounded-md uppercase text-lg transition-all duration-300 ease-in-out hover:opacity-75 text-white-100' onClick={handleReset}>Reset</button>
    //     </div>
    //   </div>
